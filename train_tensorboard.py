...
trainloader = DataLoader(Windowset(*load_eeg_label_pairs(ids=train_idx[:1]),CONFIG['WINDOW_SIZE']),batch_size=CONFIG['BATCH_SIZE'],shuffle=True)
devloader = DataLoader(Windowset(*load_eeg_label_pairs(ids=test_idx[:1]),CONFIG['WINDOW_SIZE']),batch_size=CONFIG['BATCH_SIZE'],shuffle=False)
