...
PROJECT_DIR = f'projects/merged_w{args.window}_n{args.ntraining}_b{CONFIG["BLOCKS"]}'
writer = SummaryWriter(f'runs/merged_w{args.window}_n{args.ntraining}_b{CONFIG["BLOCKS"]}')
